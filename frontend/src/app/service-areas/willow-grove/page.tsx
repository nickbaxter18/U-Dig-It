...
export default function WillowGroveServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema
        name="U-Dig It Rentals Inc - Willow Grove"
        url="https://udigit.ca/service-areas/willow-grove"
      />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving Willow Grove and surrounding Kings County
                communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <div className="mb-6 flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-gray-900">
                  Serving Willow Grove & Surrounding Area
                </h2>
              </div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                {['Willow Grove', 'Nearby Rural Communities', 'Kings County Area'].map(
                  (area: unknown) => (
                    <div
                      key={area}
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="rounded-lg border-2 border-yellow-200 bg-yellow-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">
                  Experience with rural and agricultural projects
                </p>
              </div>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">
                Equipment Available in Willow Grove
              </h2>
                ...
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1">
                    ...
                    <p className="mb-4 text-gray-700">
                      Compact Track Loader - Perfect for Willow Grove's rural properties and
                      agricultural work.
                    </p>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">
                Equipment Rental in Willow Grove
              </h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  Willow Grove is a peaceful rural community in Kings County. Our Kubota SVL75-3
                  serves local homeowners and contractors with professional equipment for
                  residential landscaping, property development, and agricultural projects.
                </p>
                <p>
                  Whether you're working on a rural property development, acreage landscaping, or
                  farm-related project in Willow Grove, our equipment delivers the power and
                  reliability you need.
                </p>
                <h3 className="pt-4 text-xl font-bold text-gray-900">
                  Why Willow Grove Customers Choose U-Dig It:
                </h3>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Rural expertise</strong> - we understand country property needs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Professional delivery</strong> - we bring equipment to your Willow
                      Grove location
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Insurance assistance</strong> - we work with local brokers
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">
                Common Equipment Rental Projects in Willow Grove
              </h2>
            ...
            <div className="mb-12 rounded-lg border-2 border-blue-200 bg-blue-50 p-8">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p>
                  <strong>Service notes:</strong> We serve Willow Grove and the surrounding rural
                  area. Call ahead to discuss access to your property if needed.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg text-white/90">
                Get a free quote for your Willow Grove project today. Our team is ready to help with
