...
export const metadata: Metadata = serviceAreaMetadata['willow-grove'];

export default function WillowGroveServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema name="U-Dig It Rentals Inc - Willow Grove" url="https://udigit.ca/service-areas/willow-grove" />

      {/* Image SEO Schema for Equipment Photo */}
      <ImageObjectSchema
        imageUrl="https://udigit.ca/images/kubota-svl-75-hero.png"
        name="Kubota SVL75-3 Track Loader Rental Willow Grove NB"
        description="Professional Kubota SVL75-3 compact track loader rental in Willow Grove, New Brunswick. Perfect for property development, land clearing, rural excavation, and acreage work in rural Kings County."
        location="Willow Grove, New Brunswick"
        width={1200}
        height={800}
      />
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
          ...
          <LocationWatermarkSet location="willow-grove" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
                ...
                <span className="bg-gradient-to-r from-[#E1BC56] via-[#F4D03F] to-[#E1BC56] bg-clip-text text-transparent">Willow Grove, NB</span>
              </h1>
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving Willow Grove and surrounding Kings County communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <div className="mb-6 flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Serving Willow Grove & Surrounding Area</h2>
              </div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                {['Willow Grove', 'Nearby Rural Communities', 'Kings County Area'].map((area: any) => (
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Professional delivery to Willow Grove area</p>
              </div>
              ...
              <div className="rounded-lg border-2 border-yellow-200 bg-yellow-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Experience with rural and agricultural projects</p>
              </div>
              <div className="rounded-lg border-2 border-purple-200 bg-purple-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Always available for Willow Grove customers</p>
              </div>
            </div>

            {/* Equipment Section */}
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Available in Willow Grove</h2>
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1">
                    <h3 className="mb-2 text-2xl font-bold text-gray-900">2025 Kubota SVL75-3</h3>
                    <p className="mb-4 text-gray-700">Compact Track Loader - Perfect for Willow Grove's rural properties and agricultural work.</p>
            ...
            {/* Local Information */}
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Rental in Willow Grove</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  Willow Grove is a peaceful rural community in Kings County. Our Kubota SVL75-3 serves local homeowners and contractors with professional equipment for residential landscaping, property development, and agricultural projects.
                </p>
                <p>
                  Whether you're working on a rural property development, acreage landscaping, or farm-related project in Willow Grove, our equipment delivers the power and reliability you need.
                </p>
                <h3 className="pt-4 text-xl font-bold text-gray-900">Why Willow Grove Customers Choose U-Dig It:</h3>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span><strong>Rural expertise</strong> - we understand country property needs</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span><strong>Professional delivery</strong> - we bring equipment to your Willow Grove location</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span><strong>Insurance assistance</strong> - we work with local brokers</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            {/* Popular Projects */}
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Common Equipment Rental Projects in Willow Grove</h2>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🏡 Rural Property Development</h3>
                  <p className="text-sm text-gray-700">Land clearing, grading, and site preparation for rural homes</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🌳 Acreage Landscaping</h3>
                  <p className="text-sm text-gray-700">Large property grading, topsoil work, and land management</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🚜 Agricultural Projects</h3>
                  <p className="text-sm text-gray-700">Field drainage, barn prep, and farm infrastructure</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🛤️ Driveway Construction</h3>
                  <p className="text-sm text-gray-700">Rural driveway grading and access road development</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🏗️ Foundation Excavation</h3>
                  <p className="text-sm text-gray-700">New home foundations and building preparation</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🌾 Land Clearing</h3>
                  <p className="text-sm text-gray-700">Tree removal, brush clearing, and lot preparation</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 rounded-lg border-2 border-blue-200 bg-blue-50 p-8">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Delivery to Willow Grove</h2>
              </div>
              <div className="space-y-3 text-gray-700">
                ...
                <p>
                  <strong>Service notes:</strong> We serve Willow Grove and the surrounding rural area. Call ahead to discuss access to your property if needed.
                </p>
              </div>
            </div>
            ...
            <div className="mb-12">
              <NearbyServiceAreas currentSlug="willow-grove" />
            </div>

            {/* CTA */}
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              <h2 className="mb-4 text-3xl font-bold">Ready to Rent in Willow Grove?</h2>
              <p className="mb-6 text-lg text-white/90">
                Get a free quote for your Willow Grove project today. Our team is ready to help with equipment selection, delivery scheduling, and insurance requirements.
              </p>
