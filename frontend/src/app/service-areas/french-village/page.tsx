...
export default function FrenchVillageServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema
        name="U-Dig It Rentals Inc - French Village"
        url="https://udigit.ca/service-areas/french-village"
      />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving French Village and surrounding Kings
                County communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {['French Village', 'Kings County Rural Communities'].map((area: unknown) => (
                  <div
                    key={area}
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                ...
                <p className="mb-4 text-gray-700">
                  Compact Track Loader - Ideal for French Village's rural residential and
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">
                Equipment Rental in French Village
              </h2>
              <p className="text-gray-700">
                French Village is a charming rural community in Kings County. Our Kubota equipment
                serves local homeowners and contractors with professional service for landscaping,
                property development, and agricultural projects.
              </p>
            </div>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg">
                Serving French Village with professional equipment and expert service.
              </p>
