...
export const metadata: Metadata = serviceAreaMetadata['french-village'];

export default function FrenchVillageServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema name="U-Dig It Rentals Inc - French Village" url="https://udigit.ca/service-areas/french-village" />

      {/* Image SEO Schema for Equipment Photo */}
      <ImageObjectSchema
        imageUrl="https://udigit.ca/images/kubota-svl-75-hero.png"
        name="Kubota SVL75-3 Track Loader Rental French Village NB"
        description="Professional Kubota SVL75-3 compact track loader rental in French Village, New Brunswick. Perfect for residential excavation, property grading, and rural development in Kings County."
        location="French Village, New Brunswick"
        width={1200}
        height={800}
      />
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
          ...
          <LocationWatermarkSet location="french-village" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
                Equipment Rental in<br /><span className="bg-gradient-to-r from-[#E1BC56] via-[#F4D03F] to-[#E1BC56] bg-clip-text text-transparent">French Village, NB</span>
              </h1>
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving French Village and surrounding Kings County communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <div className="mb-6 flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Serving French Village & Area</h2>
              </div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {['French Village', 'Kings County Rural Communities'].map((area: any) => (
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-3">
              ...
              <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Serving French Village and area</p>
              </div>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                ...
                <p className="mb-4 text-gray-700">Compact Track Loader - Ideal for French Village's rural residential and agricultural projects.</p>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Rental in French Village</h2>
              <p className="text-gray-700">French Village is a charming rural community in Kings County. Our Kubota equipment serves local homeowners and contractors with professional service for landscaping, property development, and agricultural projects.</p>
            </div>

            {/* Nearby Service Areas - Internal Linking for SEO */}
            <div className="mb-12">
              <NearbyServiceAreas currentSlug="french-village" />
            </div>

            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              <h2 className="mb-4 text-3xl font-bold">Ready to Rent in French Village?</h2>
              <p className="mb-6 text-lg">Serving French Village with professional equipment and expert service.</p>
