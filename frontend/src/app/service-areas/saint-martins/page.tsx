...
export default function SaintMartinsServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema name="U-Dig It Rentals Inc - Saint Martins" url="https://udigit.ca/service-areas/saint-martins" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
                Equipment Rental in<br /><span className="bg-gradient-to-r from-[#E1BC56] via-[#F4D03F] to-[#E1BC56] bg-clip-text text-transparent">Saint Martins, NB</span>
              </h1>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <div className="mb-6 flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Serving the Historic Village of Saint Martins</h2>
              </div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {['Saint Martins Village', 'Fundy Coastal Area', 'Sea Caves Region'].map((area: any) => (
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Available in Saint Martins</h2>
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1">
                    <h3 className="mb-2 text-2xl font-bold text-gray-900">2025 Kubota SVL75-3</h3>
                    <p className="mb-4 text-gray-700">Compact Track Loader - Perfect for Saint Martins' coastal and tourism-related projects.</p>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <p className="mb-4 text-gray-700">Saint Martins is a picturesque Bay of Fundy coastal village known for its historic covered bridges, sea caves, and scenic beauty. Our equipment handles waterfront projects, residential work, and tourism-related property development.</p>
            ...
            <div className="mb-12 rounded-lg border-2 border-blue-200 bg-blue-50 p-8">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p><strong>Service area:</strong> Saint Martins village and surrounding Fundy coastal region</p>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg">Serving the historic village and Fundy coastal community with professional equipment.</p>
