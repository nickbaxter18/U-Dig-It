...
export const metadata: Metadata = {
  ...
  description:
    'Kubota SVL75-3 rental in Hampton, NB. $450/day with delivery. Serving Hampton Village, Station, Lakeside. Agricultural & acreage property specialist. (506) 643-1575.',
  keywords:
    'equipment rental hampton nb, kubota rental hampton, farm equipment rental hampton, acreage excavation hampton, agricultural equipment hampton new brunswick, track loader hampton',
  openGraph: {
    title: 'Kubota Rental Hampton NB | Agricultural Equipment | U-Dig It',
    description:
      'Professional equipment rental in Hampton. Farm & acreage expertise. $450/day with delivery. 24/7 support.',
...
export default function HamptonServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema
        name="U-Dig It Rentals Inc - Hampton"
        url="https://udigit.ca/service-areas/hampton"
      />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving Hampton and surrounding rural areas.
                Perfect for acreage projects and agricultural work.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">
                  30-40 minute delivery from Saint John to Hampton
                </p>
              </div>
              ...
              <div className="rounded-lg border-2 border-yellow-200 bg-yellow-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">
                  Experience with acreage and agricultural projects
                </p>
              </div>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">
                Equipment Available in Hampton
              </h2>
                ...
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1">
                    ...
                    <p className="mb-4 text-gray-700">
                      Compact Track Loader - Ideal for Hampton's acreage, agricultural, and
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Hampton and surrounding rural communities require specialized equipment for larger
                  properties, acreage work, and agricultural projects. Our Kubota SVL75-3 is ideal
                  for Hampton's mix of residential, agricultural, and commercial needs.
                </p>
                <p>
                  From large lot landscaping in Lakeside Heights to agricultural drainage in
                  Smithtown and rural driveway construction in Bloomfield, we serve all of Hampton
                  and the surrounding area with professional equipment and expert support.
                </p>
                <h3 className="pt-4 text-xl font-bold text-gray-900">
                  Why Hampton Customers Choose U-Dig It:
                </h3>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Rural expertise</strong> - we understand acreage projects and
                      agricultural needs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Fast delivery</strong> - typically 30-40 minutes from Saint John
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Agricultural experience</strong> - field drainage, barn prep, and land
                      management
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Insurance help</strong> - we work with local brokers
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-gray-200 p-4">
                  ...
                  <p className="text-sm text-gray-700">
                    Field drainage, ditch maintenance, and water management for Hampton farms
                  </p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🏡 Acreage Landscaping</h3>
                  <p className="text-sm text-gray-700">
                    Large property grading, tree clearing, and land preparation
                  </p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🚜 Barn & Outbuilding Prep</h3>
                  <p className="text-sm text-gray-700">
                    Foundation excavation for agricultural buildings and equipment sheds
                  </p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🛤️ Driveway Construction</h3>
                  <p className="text-sm text-gray-700">
                    Long rural driveways, culvert installation, and grading work
                  </p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🏗️ Foundation Work</h3>
                  <p className="text-sm text-gray-700">
                    New home foundations and basement excavation in Hampton developments
                  </p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🌳 Land Clearing</h3>
                  <p className="text-sm text-gray-700">
                    Tree removal, brush clearing, and site preparation for rural properties
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 rounded-lg border-2 border-blue-200 bg-blue-50 p-8">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p>
                  <strong>Typical delivery time:</strong> 30-40 minutes from our Saint John yard to
                  Hampton
                </p>
                <p>
                  <strong>Service notes:</strong> We understand rural properties - call ahead if
                  special access arrangements are needed for your Hampton property.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg text-white/90">
                Serving Hampton's rural and agricultural community with professional equipment. Get
