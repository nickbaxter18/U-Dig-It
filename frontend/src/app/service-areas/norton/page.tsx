...
export default function NortonServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema
        name="U-Dig It Rentals Inc - Norton"
        url="https://udigit.ca/service-areas/norton"
      />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving Norton and Kings County agricultural
                communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {['Norton', 'Kings County Rural Areas'].map((area: unknown) => (
                  <div
                    key={area}
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                ...
                <p className="mb-4 text-gray-700">
                  Compact Track Loader - Perfect for Norton's agricultural and rural projects.
                </p>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <p className="mb-4 text-gray-700">
                Norton is a rural Kings County community with agricultural and residential needs.
                Our Kubota SVL75-3 handles farm drainage, land clearing, and rural property
                development.
              </p>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg">
                Serving Norton's agricultural and rural community with professional equipment.
              </p>
