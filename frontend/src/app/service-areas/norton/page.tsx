...
export const metadata: Metadata = serviceAreaMetadata.norton;

export default function NortonServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema name="U-Dig It Rentals Inc - Norton" url="https://udigit.ca/service-areas/norton" />

      {/* Image SEO Schema for Equipment Photo */}
      <ImageObjectSchema
        imageUrl="https://udigit.ca/images/kubota-svl-75-hero.png"
        name="Kubota SVL75-3 Track Loader Rental Norton NB"
        description="Professional Kubota SVL75-3 compact track loader rental in Norton, New Brunswick. Perfect for farm drainage, crop field preparation, and agricultural building prep in agricultural Kings County."
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
          ...
          <LocationWatermarkSet location="norton" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
                Equipment Rental in<br /><span className="bg-gradient-to-r from-[#E1BC56] via-[#F4D03F] to-[#E1BC56] bg-clip-text text-transparent">Norton, NB</span>
              </h1>
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving Norton and Kings County agricultural communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <div className="mb-6 flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Serving Norton & Area</h2>
              </div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {['Norton', 'Kings County Rural Areas'].map((area: any) => (
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Serving Norton and area</p>
              </div>
              ...
              <div className="rounded-lg border-2 border-yellow-200 bg-yellow-50 p-6 text-center">
                ...
                <h3 className="mb-2 text-lg font-bold text-gray-900">Agricultural Expertise</h3>
                <p className="text-sm text-gray-700">Farm and rural property experience</p>
              </div>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                ...
                <p className="mb-4 text-gray-700">Compact Track Loader - Perfect for Norton's agricultural and rural projects.</p>
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-600" /><span><strong>74.3 HP</strong> Kubota diesel</span></li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-600" /><span><strong>68" width</strong> - gate-friendly</span></li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-600" /><span><strong>3,200 lb</strong> capacity</span></li>
                </ul>
                <div className="mt-4 flex gap-3">
                  <Link href="/equipment" className="rounded-lg bg-blue-600 px-6 py-2 text-sm font-semibold text-white hover:bg-blue-700">Full Specs</Link>
                  <Link href="/book" className="rounded-lg border-2 border-blue-600 px-6 py-2 text-sm font-semibold text-blue-600 hover:bg-blue-50">Book Now</Link>
                </div>
              </div>
            </div>

            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Rental in Norton</h2>
              <p className="mb-4 text-gray-700">Norton is a rural Kings County community with agricultural and residential needs. Our Kubota SVL75-3 handles farm drainage, land clearing, and rural property development.</p>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div className="rounded-lg border border-gray-200 p-4">
                  <h4 className="mb-1 font-semibold">🌾 Farm Drainage</h4>
                  <p className="text-sm">Field work and water management</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h4 className="mb-1 font-semibold">🏡 Rural Homes</h4>
                  <p className="text-sm">Foundation and landscaping work</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h4 className="mb-1 font-semibold">🚜 Agricultural Buildings</h4>
                  <p className="text-sm">Barn and shed site preparation</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h4 className="mb-1 font-semibold">🌳 Land Clearing</h4>
                  <p className="text-sm">Tree removal and lot preparation</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12">
              <NearbyServiceAreas currentSlug="norton" />
            </div>

            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              <h2 className="mb-4 text-3xl font-bold">Ready to Rent in Norton?</h2>
              <p className="mb-6 text-lg">Serving Norton's agricultural and rural community with professional equipment.</p>
