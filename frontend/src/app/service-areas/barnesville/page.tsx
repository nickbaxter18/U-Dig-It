...
export default function BarnesvilleServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema
        name="U-Dig It Rentals Inc - Barnesville"
        url="https://udigit.ca/service-areas/barnesville"
      />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental for Barnesville and surrounding Kings County
                communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {['Barnesville', 'Surrounding Kings County Communities'].map((area: unknown) => (
                  <div
                    key={area}
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">
                Equipment Available in Barnesville
              </h2>
                ...
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1">
                    ...
                    <p className="mb-4 text-gray-700">
                      Compact Track Loader - Ideal for Barnesville's rural and agricultural
                      projects.
                    </p>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">
                Equipment Rental in Barnesville
              </h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  Barnesville and the surrounding Kings County region has a strong mix of
                  agricultural, residential, and rural commercial activity. Our Kubota SVL75-3
                  serves this diverse community with professional equipment for all project types.
                </p>
                <h3 className="pt-2 text-xl font-bold text-gray-900">
                  Popular Barnesville Projects:
                </h3>
            ...
            <div className="mb-12 rounded-lg border-2 border-blue-200 bg-blue-50 p-8">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p>
                  <strong>Service area:</strong> Barnesville and surrounding Kings County
                  communities
                </p>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg text-white/90">
                Serving Barnesville's agricultural and rural community. Get your free quote today!
              </p>
