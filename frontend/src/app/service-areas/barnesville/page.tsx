...
export const metadata: Metadata = serviceAreaMetadata.barnesville;

export default function BarnesvilleServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema name="U-Dig It Rentals Inc - Barnesville" url="https://udigit.ca/service-areas/barnesville" />

      {/* Image SEO Schema for Equipment Photo */}
      <ImageObjectSchema
        imageUrl="https://udigit.ca/images/kubota-svl-75-hero.png"
        name="Kubota SVL75-3 Track Loader Rental Barnesville NB"
        description="Professional Kubota SVL75-3 compact track loader rental in Barnesville, New Brunswick. Perfect for farm work, rural property grading, and agricultural drainage in rural Kings County."
        location="Barnesville, New Brunswick"
        width={1200}
        height={800}
      />
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
          ...
          <LocationWatermarkSet location="barnesville" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
                Equipment Rental in<br /><span className="bg-gradient-to-r from-[#E1BC56] via-[#F4D03F] to-[#E1BC56] bg-clip-text text-transparent">Barnesville, NB</span>
              </h1>
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental for Barnesville and surrounding Kings County communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <div className="mb-6 flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Serving Barnesville & Area</h2>
              </div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {['Barnesville', 'Surrounding Kings County Communities'].map((area: any) => (
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Serving Barnesville and Kings County area</p>
              </div>
              ...
              <div className="rounded-lg border-2 border-yellow-200 bg-yellow-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Agricultural and rural property experience</p>
              </div>
              <div className="rounded-lg border-2 border-purple-200 bg-purple-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Always ready to help</p>
              </div>
            </div>

            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Available in Barnesville</h2>
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1">
                    <h3 className="mb-2 text-2xl font-bold text-gray-900">2025 Kubota SVL75-3</h3>
                    <p className="mb-4 text-gray-700">Compact Track Loader - Ideal for Barnesville's rural and agricultural projects.</p>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Rental in Barnesville</h2>
              <div className="space-y-4 text-gray-700">
                <p>Barnesville and the surrounding Kings County region has a strong mix of agricultural, residential, and rural commercial activity. Our Kubota SVL75-3 serves this diverse community with professional equipment for all project types.</p>
                <h3 className="pt-2 text-xl font-bold text-gray-900">Popular Barnesville Projects:</h3>
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  <div className="rounded-lg border border-gray-200 p-4">
                    <h4 className="mb-1 font-semibold">🌾 Farm Projects</h4>
                    <p className="text-sm">Field drainage and agricultural site work</p>
                  </div>
                  <div className="rounded-lg border border-gray-200 p-4">
                    <h4 className="mb-1 font-semibold">🏡 Rural Residential</h4>
                    <p className="text-sm">Large lot landscaping and foundations</p>
                  </div>
                  <div className="rounded-lg border border-gray-200 p-4">
                    <h4 className="mb-1 font-semibold">🚜 Agricultural Buildings</h4>
                    <p className="text-sm">Barn and equipment shed preparation</p>
                  </div>
                  <div className="rounded-lg border border-gray-200 p-4">
                    <h4 className="mb-1 font-semibold">🛤️ Rural Driveways</h4>
                    <p className="text-sm">Long access roads and driveway construction</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 rounded-lg border-2 border-blue-200 bg-blue-50 p-8">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Delivery to Barnesville</h2>
              </div>
              <div className="space-y-3 text-gray-700">
                <p><strong>Delivery fee:</strong> $150 each way (total $300 for delivery + pickup)</p>
                <p><strong>Service area:</strong> Barnesville and surrounding Kings County communities</p>
              </div>
            </div>

            {/* Nearby Service Areas - Internal Linking for SEO */}
            <div className="mb-12">
              <NearbyServiceAreas currentSlug="barnesville" />
            </div>

            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              <h2 className="mb-4 text-3xl font-bold">Ready to Rent in Barnesville?</h2>
              <p className="mb-6 text-lg text-white/90">Serving Barnesville's agricultural and rural community. Get your free quote today!</p>
              <div className="flex flex-col gap-4 sm:flex-row">
                <Link href="/book" className="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-8 py-4 font-bold text-[#A90F0F] hover:bg-gray-100"><span>📅</span><span>Book Online</span></Link>
