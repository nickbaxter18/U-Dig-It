...
export const metadata: Metadata = {
  ...
  description: 'Kubota SVL75-3 rental in Grand Bay-Westfield, NB. $450/day with delivery. Serving Epworth Park, Hillandale, Ingleside. Bay of Fundy waterfront specialist. (506) 643-1575.',
  keywords: 'equipment rental grand bay westfield, kubota rental westfield nb, track loader grand bay, waterfront equipment grand bay, bay of fundy equipment rental, westfield nb excavation',
  openGraph: {
    title: 'Equipment Rental Grand Bay-Westfield | Bay of Fundy | U-Dig It',
    description: 'Professional equipment rental in Grand Bay-Westfield. Waterfront & coastal expertise. $450/day with delivery.',
...
export default function GrandBayWestfieldServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema name="U-Dig It Rentals Inc - Grand Bay-Westfield" url="https://udigit.ca/service-areas/grand-bay-westfield" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
                Equipment Rental in<br /><span className="bg-gradient-to-r from-[#E1BC56] via-[#F4D03F] to-[#E1BC56] bg-clip-text text-transparent">Grand Bay-Westfield, NB</span>
              </h1>
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving Grand Bay-Westfield and Bay of Fundy shoreline communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                {['Grand Bay', 'Westfield', 'Epworth Park', 'Acamac', 'Ingleside', 'Morna', 'Belyeas Cove'].map((area: any) => (
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Professional delivery along Route 7 corridor</p>
              </div>
              ...
              <div className="rounded-lg border-2 border-yellow-200 bg-yellow-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Specialized in Bay of Fundy shoreline projects</p>
              </div>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Available in Grand Bay-Westfield</h2>
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1">
                    <h3 className="mb-2 text-2xl font-bold text-gray-900">2025 Kubota SVL75-3</h3>
                    <p className="mb-4 text-gray-700">Compact Track Loader - Perfect for waterfront and residential projects in Grand Bay-Westfield.</p>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">About Grand Bay-Westfield Rentals</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  Grand Bay-Westfield sits along the scenic Bay of Fundy coastline and Route 7 corridor. This community combines waterfront properties, residential developments, and rural acreage, making it a diverse market for equipment rental.
                </p>
                <p>
                  From Epworth Park to Acamac, from coastal properties in Grand Bay to inland developments in Westfield, our Kubota SVL75-3 serves all areas with professional equipment and reliable service.
                </p>
                <h3 className="pt-4 text-xl font-bold text-gray-900">Why Grand Bay-Westfield Customers Choose U-Dig It:</h3>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span><strong>Waterfront expertise</strong> - experience with Bay of Fundy coastal properties</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span><strong>Route 7 access</strong> - efficient delivery along the corridor</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span><strong>Coastal conditions</strong> - understanding of tidal and shoreline challenges</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Common Projects in Grand Bay-Westfield</h2>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🌊 Waterfront Landscaping</h3>
                  <p className="text-sm text-gray-700">Bay of Fundy property grading, retaining walls, erosion control</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                ...
                <div className="rounded-lg border border-gray-200 p-4">
                  ...
                  <p className="text-sm text-gray-700">Basement and crawl space excavation for Route 7 homes</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🛤️ Shoreline Improvements</h3>
                  <p className="text-sm text-gray-700">Coastal property stabilization and landscaping</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 rounded-lg border-2 border-blue-200 bg-blue-50 p-8">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Delivery to Grand Bay-Westfield</h2>
              </div>
              <div className="space-y-3 text-gray-700">
                <p><strong>Delivery fee:</strong> $150 each way (total $300 for delivery + pickup)</p>
                <p><strong>Typical delivery time:</strong> 25-35 minutes via Route 7 from Saint John</p>
                <p><strong>Service notes:</strong> We serve all communities along the Route 7 corridor from Grand Bay to Westfield.</p>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg text-white/90">Get a free quote for your Grand Bay-Westfield project. We're ready to help with equipment selection and delivery!</p>
