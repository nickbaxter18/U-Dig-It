  ...
  return (
    <>
      ...
      <ImageObjectSchema
        ...
        name="Kubota SVL75-3 Track Loader Rental Sussex NB"
        description="Professional Kubota SVL75-3 compact track loader rental in Sussex, New Brunswick - Dairy Capital of the Maritimes. Perfect for dairy farm equipment, barn preparation, agricultural drainage, and manure management."
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Serving Sussex and surrounding area</p>
              </div>
              ...
              <div className="rounded-lg border-2 border-yellow-200 bg-yellow-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Dairy farm and agricultural experience</p>
              </div>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div className="rounded-lg border border-gray-200 p-4">
                  ...
                  <p className="text-sm">Barn prep, drainage, manure management</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h4 className="mb-1 font-semibold">🌾 Agricultural Work</h4>
                  <p className="text-sm">Field drainage and crop land preparation</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h4 className="mb-1 font-semibold">🏡 Rural Residential</h4>
                  <p className="text-sm">Home foundations and acreage landscaping</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h4 className="mb-1 font-semibold">🚜 Equipment Sheds</h4>
                  <p className="text-sm">Agricultural building preparation</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12">
              <NearbyServiceAreas currentSlug="sussex" />
            </div>
