...
export default function BaxtersCornerServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema name="U-Dig It Rentals Inc - Baxters Corner" url="https://udigit.ca/service-areas/baxters-corner" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
                Equipment Rental in<br /><span className="bg-gradient-to-r from-[#E1BC56] via-[#F4D03F] to-[#E1BC56] bg-clip-text text-transparent">Baxters Corner, NB</span>
              </h1>
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving Baxters Corner and surrounding rural communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {['Baxters Corner', 'Kings County Rural Areas'].map((area: any) => (
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                ...
                <p className="mb-4 text-gray-700">Compact Track Loader - Perfect for Baxters Corner rural and farm projects.</p>
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Rental in Baxters Corner</h2>
              <p className="text-gray-700">Baxters Corner is a quiet rural community in Kings County. Our Kubota equipment serves local farms, residential properties, and land development projects.</p>
            </div>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg">Serving Baxters Corner's rural community with professional equipment.</p>
