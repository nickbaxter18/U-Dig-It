...
export default function LornevilleServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema
        name="U-Dig It Rentals Inc - Lorneville"
        url="https://udigit.ca/service-areas/lorneville"
      />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving Lorneville's industrial and residential
                areas along the Bay of Fundy.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                {['Lorneville', 'Mispec', 'Dipper Harbour', 'Chance Harbour'].map(
                  (area: unknown) => (
                    <div
                      key={area}
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">
                Equipment Available in Lorneville
              </h2>
                ...
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1">
                    ...
                    <p className="mb-4 text-gray-700">
                      Compact Track Loader - Ideal for Lorneville's industrial, coastal, and
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">
                Equipment Rental in Lorneville
              </h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  Lorneville is a unique community combining industrial, residential, and coastal
                  properties along the Bay of Fundy. Our Kubota SVL75-3 handles everything from
                  industrial site work to waterfront residential projects.
                </p>
                <p>
                  Located in West Saint John near the Fundy shoreline, Lorneville features
                  industrial operations, residential neighborhoods, and scenic coastal properties.
                  Our equipment serves all of these diverse needs with professional service and
                  reliable delivery.
                </p>
                <h3 className="pt-4 text-xl font-bold text-gray-900">
                  Why Lorneville Customers Choose U-Dig It:
                </h3>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Industrial expertise</strong> - experience with commercial and
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Fast delivery</strong> - close proximity to West Saint John
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span>
                      <strong>Coastal property experience</strong> - Bay of Fundy waterfront
                      projects
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
            ...
            <div className="mb-12 rounded-lg border-2 border-blue-200 bg-blue-50 p-8">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p>
                  <strong>Typical delivery time:</strong> 15-20 minutes from Saint John to
                  Lorneville
                </p>
                <p>
                  <strong>Service notes:</strong> Quick access from West Saint John. We serve
                  industrial sites and residential properties throughout Lorneville.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg text-white/90">
                Get a free quote for your Lorneville project today. Serving industrial, commercial,
