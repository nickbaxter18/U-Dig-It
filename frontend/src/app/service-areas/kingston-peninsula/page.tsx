...
export default function KingstonPeninsulaServiceAreaPage() {
  return (
    <>
      <LocalBusinessSchema name="U-Dig It Rentals Inc - Kingston Peninsula" url="https://udigit.ca/service-areas/kingston-peninsula" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
                ...
                <span className="bg-gradient-to-r from-[#E1BC56] via-[#F4D03F] to-[#E1BC56] bg-clip-text text-transparent">Kingston Peninsula, NB</span>
              </h1>
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Professional Kubota SVL75-3 rental serving Kingston Peninsula and Kennebecasis River waterfront communities.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <div className="mb-6 flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Communities on the Kingston Peninsula</h2>
              </div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                {['Kingston', 'Summerville', 'Long Reach', 'Bayswater', 'Reed\'s Point', 'Clifton Royal', 'Reeds Point', 'Browns Flat'].map((area: any) => (
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6 text-center">
                ...
                <p className="text-sm text-gray-700">Professional delivery to peninsula communities</p>
              </div>
            ...
            {/* Equipment Section */}
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Available on Kingston Peninsula</h2>
              <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1">
                    <h3 className="mb-2 text-2xl font-bold text-gray-900">2025 Kubota SVL75-3</h3>
                    <p className="mb-4 text-gray-700">Compact Track Loader - Perfect for Kingston Peninsula's waterfront properties and rural developments.</p>
            ...
            {/* Local Information */}
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Equipment Rental on Kingston Peninsula</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  Kingston Peninsula is a scenic region stretching along the Kennebecasis River and Long Reach, featuring waterfront properties, rural acreage, and charming communities. Our Kubota SVL75-3 is ideal for the peninsula's unique mix of waterfront landscaping, residential development, and agricultural projects.
                </p>
                <p>
                  From waterfront estates in Bayswater to rural properties in Summerville and Long Reach developments, we serve the entire Kingston Peninsula with professional equipment and reliable service.
                </p>
                <h3 className="pt-4 text-xl font-bold text-gray-900">Why Kingston Peninsula Customers Choose U-Dig It:</h3>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span><strong>Waterfront property expertise</strong> - Kennebecasis River shoreline experience</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span><strong>Peninsula access</strong> - we understand peninsula delivery logistics</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
                    <span><strong>Rural and waterfront balance</strong> - experience with both property types</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-green-600" />
            ...
            {/* Popular Projects */}
            <div className="mb-12 rounded-lg bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-3xl font-bold text-gray-900">Common Projects on Kingston Peninsula</h2>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🌊 Waterfront Landscaping</h3>
                  <p className="text-sm text-gray-700">Kennebecasis River shoreline grading, retaining walls, erosion control</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🏡 Estate Properties</h3>
                  <p className="text-sm text-gray-700">Large waterfront lot development and landscaping</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🏗️ Foundation Work</h3>
                  <p className="text-sm text-gray-700">New home foundations and basement excavation</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                ...
                <div className="rounded-lg border border-gray-200 p-4">
                  ...
                  <p className="text-sm text-gray-700">In-ground pool excavation for waterfront properties</p>
                </div>
                <div className="rounded-lg border border-gray-200 p-4">
                  <h3 className="mb-2 font-semibold text-gray-900">🌳 Land Clearing</h3>
                  <p className="text-sm text-gray-700">Tree clearing for peninsula property development</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 rounded-lg border-2 border-blue-200 bg-blue-50 p-8">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p><strong>Typical delivery time:</strong> 25-40 minutes depending on peninsula location</p>
                <p><strong>Service notes:</strong> We serve all Kingston Peninsula communities. Ferry schedules and access routes considered for delivery planning.</p>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg text-white/90">
                Get a free quote for your Kingston Peninsula project today. We're ready to help with equipment selection, delivery scheduling, and insurance requirements.
              </p>
