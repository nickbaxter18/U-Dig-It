...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      'Yes — 21 years old. The person signing the rental agreement must be at least 21 and must be competent to operate heavy equipment or ensure that only qualified operators use the machine.',
  },
  {
    ...
    answer:
      "Yes, but all operators must be competent adults (21+) authorized by the renter. The renter remains fully responsible for all operators' actions. Any operator impaired by alcohol, cannabis, or drugs is strictly prohibited.",
  },
  {
    ...
    answer:
      'Lack of required insurance, failure to provide a valid ID or COI, past rental violations, outstanding debts, or any indication of unsafe practices. We reserve the right to refuse rental at our discretion.',
  },
  ...
  // Insurance & Liability (3)
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          <strong>Yes — insurance is mandatory.</strong> You need a Certificate of Insurance (COI)
          showing:
        </p>
        <ul className="list-disc pl-6 space-y-1">
          <li>
            <strong>Commercial General Liability (CGL):</strong> ≥ $2,000,000 per occurrence
          </li>
          <li>
            <strong>U-Dig It Rentals Inc.</strong> listed as <strong>Additional Insured</strong>{' '}
            (primary & non-contributory)
          </li>
          <li>
            <strong>Waiver of Subrogation</strong> in our favor
          </li>
          <li>
            <strong>Rented/Leased Equipment coverage:</strong> ≥ full replacement value ($120,000+)
          </li>
          <li>
            <strong>U-Dig It Rentals Inc.</strong> as <strong>Loss Payee</strong>
          </li>
          <li>
            <strong>Auto Liability:</strong> ≥ $1,000,000 if you transport the equipment
          </li>
        </ul>
        <p className="text-sm text-blue-700 font-semibold">
          ...
          with local brokers and email templates.
        </p>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          Often, yes! Many renters get a <strong>short-term rental policy</strong> from a broker for
          as little as $150–$300 for a week. Check our{' '}
          <Link href="/insurance" className="underline font-semibold">
            Insurance Guide
          </Link>{' '}
          for local brokers who specialize in equipment rental coverage.
        </p>
        <p className="text-sm text-gray-600">
          Typical turnaround: 1-2 business days. We recommend getting your COI at least 3 days
          before your rental start date.
        </p>
      </div>
    ),
  },
  {
    ...
    answer:
      'Our coverage protects us for downtime and loss-of-use. Your liability insurance protects you (and us as Additional Insured) if the equipment causes third-party injury or property damage. It also covers the replacement value if the machine is totaled or stolen. Both coverages work together for complete protection.',
  },
  ...
  // Pricing, Deposits & Payments (2)
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          <strong>Yes — a $500 refundable security hold.</strong>
        </p>
        <ul className="list-disc pl-6 space-y-1">
          <li>
            <strong>When:</strong> Placed 48 hours before your rental start date
          </li>
          <li>
            <strong>How:</strong> Authorization (hold) on your saved credit/debit card — not an
            actual charge
          </li>
          <li>
            <strong>Release:</strong> Automatically released within 24 hours when you return the
            equipment clean, refueled, and in good condition
          </li>
          <li>
            <strong>Charges:</strong> The hold may be charged for damage beyond normal wear, failure
            to refuel ($100), or excessive cleaning ($100)
          </li>
        </ul>
        <p className="text-sm text-gray-600">
          The $500 hold is a temporary authorization and does not cap your liability for major
  ...
  },
  {
    ...
    answer:
      'We accept all major credit/debit cards (Visa, Mastercard, Amex) via Stripe. For large commercial bookings, we also accept Interac e-Transfer or invoicing with NET 7-14 day terms (subject to credit approval).',
  },
  ...
  // Delivery & Transport (2)
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          <strong>Yes!</strong> We offer delivery and pickup within the Greater Saint John area.
        </p>
        <ul className="list-disc pl-6 space-y-1">
          <li>
            <strong>Fee:</strong> $150 each way (total $300 for delivery + pickup)
          </li>
          <li>
            <strong>Service:</strong> We load, transport, and unload at your site
          </li>
          <li>
            <strong>Requirements:</strong> Safe, level access for our trailer; clear path to work
            area
          </li>
          <li>
            <strong>Distance:</strong> Pricing may vary for locations beyond 50 km from Saint John
          </li>
        </ul>
        <p className="text-sm text-gray-600">
          Delivery must be scheduled at booking. Last-minute requests subject to availability.
        </p>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          <strong>Yes</strong>, if you have appropriate equipment and insurance:
        </p>
        <ul className="list-disc pl-6 space-y-1">
        ...
        <p className="text-sm text-red-700 font-semibold">
          You are responsible for safe loading, tie-down, transport, and unloading. We recommend
          professional loading assistance. Never ride in the cab during loading/unloading.
        </p>
      </div>
    ),
  },
    ...
    answer: (
      <div className="space-y-3">
        ...
        <p className="text-sm text-blue-700 font-semibold">
          ...
          page for complete PPE and operating requirements.
        </p>
      </div>
    ),
  },
  {
    ...
    answer:
      "You must be competent to operate the equipment. We provide basic orientation on controls and safety features at delivery/pickup. If you're new to skid steers, we strongly recommend seeking professional training or hiring an experienced operator. WorkSafeNB and other organizations offer operator certification courses.",
  },
  {
    id: 'operating-limits',
    section: 'Safety & Operation',
    ...
    answer: (
      <div className="space-y-3">
        <p>
          <strong>Yes. Critical limits include:</strong>
        </p>
        <ul className="list-disc pl-6 space-y-1">
          <li>
            <strong>Max slope/grade:</strong> ≤ 25° — travel straight up/down, never side-hill
          </li>
          <li>
            <strong>No riders:</strong> Operator only in the cab — never carry passengers
          </li>
          <li>
            <strong>No lifting people:</strong> Never use as a man-lift or aerial platform
          </li>
          <li>
            <strong>Rated capacity:</strong> Stay within manufacturer load ratings (see operator
            manual)
          </li>
          <li>
            <strong>Prohibited uses:</strong> No demolition beyond rated capability, no hazmat, no
            saltwater operation
          </li>
        </ul>
        <p className="text-sm text-gray-600">
          See the Equipment Rider and Operator\'s Manual for complete operating limits.
        </p>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        ...
        <p>
          Before any ground disturbance, you <strong>must</strong> have utility locates completed
          and marked on site. This includes:
        </p>
        <ul className="list-disc pl-6 space-y-1">
        ...
        <p className="text-sm">
          In New Brunswick, contact <strong>Click Before You Dig (1-800-565-2345)</strong> at least
          3 business days before digging.
        </p>
        <p className="text-sm font-semibold text-red-700">
          You are 100% responsible for utility strike damage, fines, and downtime. Failure to locate
  ...
  // Checklists & Daily Use (2)
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          <strong>Daily Pre-Start Inspection (required):</strong>
        </p>
        ...
        <p className="text-sm text-blue-700 font-semibold">
          Full checklist available in our{' '}
          <Link href="/safety" className="underline">
            Safety Guidance
          </Link>{' '}
          page.
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          <strong>Maximum slope: 25° (46% grade).</strong> Best practices:
        </p>
        <ul className="list-disc pl-6 space-y-1 text-sm">
          <li>
            Travel <strong>straight up/down</strong> — never across the slope (side-hilling)
          </li>
          <li>
            Keep the bucket/attachment <strong>low and tilted back</strong> when traveling
          </li>
          <li>Drive slowly and maintain control at all times</li>
          <li>Avoid sudden movements or sharp turns on grades</li>
          <li>
            If the machine feels unstable, <strong>stop immediately</strong> and back down slowly
          </li>
          <li>Never load or unload on a slope</li>
        </ul>
        <p className="text-sm font-semibold text-red-700">
          If you\'re unsure about slope safety, don\'t risk it. Contact us for guidance.
        </p>
      </div>
    ),
  },
  ...
  // Incidents & Emergencies (1)
  {
    ...
    answer: (
      <div className="space-y-3">
        ...
        <p>
          <strong>Then immediately contact U‑Dig It Rentals:</strong>
        </p>
        <ul className="list-disc pl-6 space-y-1">
          <li>
            Phone:{' '}
            <a href="tel:+15066431575" className="text-blue-600 underline font-semibold">
              1-506-643-1575
            </a>
          </li>
          <li>
            Email:{' '}
            <a href="mailto:nickbaxter@udigit.ca" className="text-blue-600 underline">
              nickbaxter@udigit.ca
            </a>
          </li>
        </ul>
        <p>
          <strong>For utility strikes:</strong> Also notify the utility company immediately.
        </p>
        <p>
          <strong>For theft/vandalism:</strong> File a police report and provide us with the report
          number.
        </p>
        <p className="text-sm text-gray-600">
          Do NOT move the equipment after an incident unless it poses an immediate safety hazard.
          Take photos and document the scene.
        </p>
        <p className="text-sm font-semibold">
          Failure to report incidents promptly may affect your insurance claim and liability.
        </p>
      </div>
    ),
  },
    ...
    answer: (
      <div className="space-y-3">
        ...
        <ul className="list-disc pl-6 space-y-1 text-sm">
          ...
          <li>
            Notify us when ready for pickup (if delivery service) or bring to our yard during
            business hours
          </li>
        </ul>
        <p className="text-sm text-green-700 font-semibold">
          Equipment returned clean, refueled, and in good condition = $500 security hold released
          within 24 hours!
        </p>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        <p>
          <strong>Fuel:</strong> Return with a <strong>full tank of diesel</strong>. If not full, we
          charge a flat $100 refueling fee (or actual fuel cost + $50 service fee, whichever is
          greater).
        </p>
        <p>
          <strong>Cleaning:</strong> Remove <strong>excessive mud, dirt, and debris</strong>. A
          quick wash-down is appreciated but not required. Heavy cleaning (caked mud, contamination)
          is billed at $100 flat rate.
        </p>
        <p className="text-sm text-gray-600">
          Normal job-site dirt is expected. We\'re looking for reasonable cleanliness, not showroom
          condition.
        </p>
      </div>
    ),
    ...
    answer: (
      <div className="space-y-3">
        ...
        <p className="text-sm text-gray-600 mt-3">
          Your signed rental agreement and equipment rider govern if there\'s any conflict with
          these FAQs.
        </p>
      </div>
    ),
  },
  {
    ...
    answer:
      'All rental agreements and disputes are governed by the laws of the Province of New Brunswick and the federal laws of Canada. Venue and jurisdiction lie with the courts of New Brunswick.',
  },
];
            ...
            <div className="lg:col-span-3">
              ...
              <div className="space-y-8">
                {sections.map((section: unknown) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`flex items-center gap-3 rounded-t-lg border-l-4 p-6 ${colorClasses[section.color as keyof typeof colorClasses]}`}
                      >
              ...
              <div className="mt-8 rounded-lg border-2 border-red-200 bg-red-50 p-6">
                ...
                <p className="mb-4 text-red-800">
                  ...
                  <a href="tel:+15066431575" className="font-bold underline">
                    1-506-643-1575
                  </a>
                  .
                </p>
                <p className="text-sm text-red-700">
                  ...
                  <a href="mailto:nickbaxter@udigit.ca" className="underline">
                    nickbaxter@udigit.ca
                  </a>
                  .
                </p>
