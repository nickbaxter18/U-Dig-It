...
export const metadata: Metadata = {
  ...
  description:
    'Navigate NB excavation regulations with confidence. Complete 2025 guide to permits, utility locates, insurance requirements, and legal compliance for construction projects in New Brunswick.',
  keywords:
    'excavation permit new brunswick, nb utility locate requirements, construction insurance nb, building permit saint john, excavation regulations new brunswick, nb one call',
  openGraph: {
    title: 'NB Excavation Permits & Insurance Guide 2025 | U-Dig It',
    description:
      'Complete guide to NB regulations: permits, utility locates, insurance requirements, legal compliance.',
          ...
          <div className="prose prose-lg max-w-none">
            <div className="rounded-lg border-l-4 border-[#E1BC56] bg-yellow-50 p-6 not-prose">
              <p className="text-lg text-gray-700">
                <strong>Planning an excavation project in New Brunswick?</strong> Understanding
                permit requirements and insurance obligations can save you from costly fines,
                project delays, and legal liability. This complete 2025 guide covers everything you
                need to know about excavation regulations, utility locates, building permits, and
                insurance requirements in NB.
              </p>
            </div>
                ...
                <div className="mb-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-gray-700">
                      <p>
                        <strong>Service:</strong> NB One Call
                      </p>
                      <p>
                        <strong>Phone:</strong> 1-800-565-2754
                      </p>
                      <p>
                        <strong>Notice Required:</strong> Minimum 3 business days before digging
                      </p>
                      <p>
                        <strong>Cost:</strong> FREE
                      </p>
                      <p>
                        <strong>Coverage:</strong> All underground utilities (power, gas, telecom,
                        water, sewer, fiber optic)
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <ol>
              <li>
                <strong>Call NB One Call:</strong> Provide project address, dig area description,
                start date
              </li>
              <li>
                <strong>Utility companies notified:</strong> NB Power, Enbridge Gas, Bell, Rogers,
                Saint John Water, etc.
              </li>
              <li>
                <strong>Locators mark utilities:</strong> Colored flags/paint indicate buried lines
              </li>
              <li>
                <strong>Wait 3 business days:</strong> All utilities must respond within this
                timeframe
              </li>
              <li>
                <strong>Hand dig within 1 meter:</strong> Use hand tools (not machine) near marked
                utilities
              </li>
              <li>
                <strong>Locate valid 21 days:</strong> If project delayed, must call again
              </li>
            </ol>
            ...
            <div className="not-prose">
              <div className="my-6 space-y-3">
                {[
                  {
                    situation: 'New home foundation',
                    required: true,
                    details: 'Full building permit required',
                  },
                  {
                    situation: 'Home addition foundation',
                    required: true,
                    details: 'Building permit + structural drawings',
                  },
                  {
                    situation: 'In-ground pool',
                    required: true,
                    details: 'Pool permit from Planning & Development',
                  },
                  {
                    situation: 'Detached garage/shed foundation',
                    required: true,
                    details: 'If >10 m² (108 sq ft)',
                  },
                  {
                    situation: 'Landscaping/grading',
                    required: false,
                    details: 'Unless changing drainage patterns',
                  },
                  {
                    situation: 'Driveway (on your property)',
                    required: false,
                    details: 'No permit needed',
                  },
                  {
                    situation: 'Driveway (crossing sidewalk/street)',
                    required: true,
                    details: 'Right-of-Way permit required',
                  },
                  {
                    situation: 'Utility trench (private property)',
                    required: false,
                    details: 'Call utilities, get locates',
                  },
                ].map((item: unknown, index: unknown) => (
                  <div
                    key={index}
                    className={`rounded-lg border-2 p-4 ${item.required ? 'border-red-200 bg-red-50' : 'border-green-200 bg-green-50'}`}
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span
                          className={`ml-2 font-semibold ${item.required ? 'text-red-700' : 'text-green-700'}`}
                        >
            ...
            <ul>
              <li>
                <strong>Planning & Development:</strong> (506) 658-2855
              </li>
              <li>
                <strong>Building Inspections:</strong> (506) 658-2870
              </li>
              <li>
                <strong>Engineering Services:</strong> (506) 658-2850
              </li>
              <li>
                <strong>Address:</strong> City Hall, 15 Market Square, Saint John
              </li>
              <li>
            ...
            <p>
              <strong>
                U-Dig It Rentals requires proof of insurance BEFORE equipment release. Here's
              ...
              <div className="my-6 space-y-4">
                <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>
                      • <strong>Limit:</strong> $2,000,000 per occurrence minimum
                    </li>
                    <li>
                      • <strong>Additional Insured:</strong> U-Dig It Rentals Inc. must be named
                    </li>
                    <li>
                      • <strong>Primary & Non-Contributory:</strong> Required endorsement
                    </li>
                    <li>
                      • <strong>Waiver of Subrogation:</strong> In favor of U-Dig It Rentals Inc.
                    </li>
                    <li>
                      • <strong>Coverage:</strong> Bodily injury, property damage, personal injury
                    </li>
                  </ul>
                </div>
                ...
                <div className="rounded-lg border-2 border-purple-200 bg-purple-50 p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>
                      • <strong>Limit:</strong> Full replacement value ($120,000 for SVL75-3)
                    </li>
                    <li>
                      • <strong>Loss Payee:</strong> U-Dig It Rentals Inc.
                    </li>
                    <li>
                      • <strong>Coverage:</strong> Physical damage, theft, fire, vandalism
                    </li>
                    <li>
                      • <strong>Deductible:</strong> Your responsibility
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <p>
              <strong>Option 1: Add to Existing Policy (Homeowners/Business)</strong>
            </p>
            <ul>
              <li>
            ...
            <p>
              <strong>Option 2: Short-Term Rental Policy</strong>
            </p>
            <ul>
            ...
            <p>
              <strong>Option 3: U-Dig It Referral Partners</strong>
            </p>
            <p>
              We work with Saint John insurance brokers who specialize in equipment rental coverage
              and can provide same-day quotes.{' '}
              <Link href="/insurance" className="font-semibold text-[#A90F0F] underline">
                See our Insurance Guide
              </Link>{' '}
              for recommended brokers.
            </p>

            <div className="rounded-lg border-l-4 border-green-600 bg-green-50 p-6 not-prose">
              <p className="text-gray-700">
                <strong>💡 Pro Tip:</strong> Get your insurance quote BEFORE booking equipment to
                avoid delays. Most brokers can provide coverage certificates within 24 hours.
              </p>
            </div>
            ...
            <p>
              <strong>You need provincial approval for:</strong>
            </p>

            <ul>
              <li>
                <strong>Watercourse alteration:</strong> Any work within 30m of stream, river, or
                wetland
              </li>
              <li>
                <strong>Fill placement:</strong> Dumping clean fill in wetlands or near water
              </li>
              <li>
                <strong>Large excavations:</strong> Removal of &gt;1,000 cubic meters of material
              </li>
              <li>
                <strong>Contaminated sites:</strong> Any site with known or suspected contamination
              </li>
            </ul>

            <p>
              <strong>Contact:</strong> NB Department of Environment - Environmental Impact
              Assessment: 1-877-662-6800
            </p>
            ...
            <ul>
              <li>
                <strong>WCB coverage required</strong> for all workers
              </li>
              <li>
                <strong>Fall protection plan</strong> for excavations over 3m (10 feet) deep
              </li>
              <li>
                <strong>Confined space procedures</strong> for deep pits or trenches
              </li>
              <li>
                <strong>Traffic control plan</strong> if working near roads
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                <strong>Contact:</strong> (506) 658-2855
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                <strong>Contact:</strong> (506) 848-6600
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                <strong>Contact:</strong> (506) 849-5000
              </li>
            </ul>
            ...
            <p>
              <strong>Real examples of what happens when regulations are ignored:</strong>
            </p>
              ...
              <div className="my-6 space-y-4">
                <div className="rounded-lg border border-red-300 bg-white p-6">
                  ...
                  <ul className="space-y-1 text-gray-700">
                    ...
                    <li>
                      • Building permit retroactively required: $400 application + $800 inspection
                      fees
                    </li>
                    <li>• Engineered drawings required after fact: $1,500-2,500</li>
                    <li>
                      • <strong>Total cost: $3,200-4,400 + project delays</strong>
                    </li>
                  </ul>
                </div>
                ...
                <div className="rounded-lg border border-red-300 bg-white p-6">
                  ...
                  <ul className="space-y-1 text-gray-700">
                    ...
                    <li>
                      • <strong>Total cost: $100,000-680,000+</strong>
                    </li>
                  </ul>
                </div>
                ...
                <div className="rounded-lg border border-red-300 bg-white p-6">
                  ...
                  <ul className="space-y-1 text-gray-700">
                    ...
                    <li>
                      • <strong>Total out-of-pocket: $5,650</strong>
                    </li>
                    <li>
                      • <em>With insurance: $500-1,000 deductible only</em>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="not-prose">
              <div className="my-6 rounded-lg border-2 border-gray-200 bg-white p-6">
                ...
                <div className="space-y-3">
                  {[
                    {
                      task: 'Call NB One Call (1-800-565-2754)',
                      deadline: '3+ business days before',
                    },
                    {
                      task: 'Check if building/pool permit needed',
                      deadline: '2-4 weeks before (permit processing time)',
                    },
                    { task: 'Obtain insurance coverage', deadline: '1-3 days before' },
                    {
                      task: 'Submit insurance certificates to rental company',
                      deadline: 'Before equipment release',
                    },
                    {
                      task: 'Wait for utility locates to be marked',
                      deadline: 'Full 3 business days',
                    },
                    { task: 'Photograph all locate markings', deadline: 'Before digging' },
                    {
                      task: 'Hand-dig test holes within 1m of utilities',
                      deadline: 'Before using machine',
                    },
                  ].map((item: unknown, index: unknown) => (
                    <div
                      key={index}
            ...
            <p>
              <strong>When you rent from us, we help with:</strong>
            </p>
            ...
            <p>
              Compliance isn't complicated when you have the right guidance. U-Dig It Rentals
              provides professional equipment rental with complete regulatory support for Greater
              Saint John projects.
            </p>
            ...
            <div className="not-prose">
              <div className="my-8 rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
                ...
                <p className="mb-6 text-lg text-white/90">
                  We'll help you navigate permits, insurance, and safety requirements. Professional
                  service with complete compliance support.
                </p>
