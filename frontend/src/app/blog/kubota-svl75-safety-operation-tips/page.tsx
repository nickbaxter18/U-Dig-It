...
export const metadata: Metadata = {
  ...
  description:
    'Master safe operation of the Kubota SVL75-3 track loader. Complete guide covering pre-start checks, safety protocols, operating tips, and common mistakes to avoid. Expert advice from U-Dig It Rentals NB.',
  keywords:
    'kubota svl75-3 operation, how to operate track loader, kubota safety guide, skid steer operation tips, heavy equipment safety nb, track loader training',
  openGraph: {
    title: 'How to Operate Kubota Track Loader Safely | Complete Guide',
    description:
      'Expert safety & operation guide for Kubota SVL75-3. Pre-start checks, safety protocols, operating tips.',
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
          ...
          <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
            <div className="mb-6 inline-block">
              <span className="rounded-full border border-red-500/30 bg-red-500/20 px-4 py-2 text-sm font-semibold tracking-wide text-red-400">
                SAFETY GUIDE
              </span>
            </div>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="rounded-lg border-l-4 border-red-600 bg-red-50 p-6 not-prose">
              <p className="text-lg text-gray-700">
                <strong>Safety First:</strong> The Kubota SVL75-3 is a powerful machine weighing
                over 9,000 pounds. Improper operation can result in serious injury, death, or
                property damage. This guide provides essential safety information, but is NOT a
                substitute for reading the complete Operator's Manual and receiving proper training.
              </p>
            </div>
            ...
            <p>
              NEVER skip the pre-start inspection. 80% of equipment failures can be prevented with
              daily checks:
            </p>
            ...
            <div className="not-prose">
              <div className="my-6 space-y-3">
                {[
                  {
                    item: 'Visual Walk-Around',
                    check: 'Look for fluid leaks, damage, loose parts, debris',
                  },
                  {
                    item: 'Engine Oil Level',
                    check: 'Check dipstick - add if low (10W-30 or 15W-40)',
                  },
                  {
                    item: 'Hydraulic Fluid',
                    check: 'Check sight glass - should be at "FULL COLD" mark',
                  },
                  {
                    item: 'Coolant Level',
                    check: 'Check overflow tank - fill to MAX line if needed',
                  },
                  { item: 'Fuel Level', check: 'Start each day with full tank to avoid downtime' },
                  {
                    item: 'Tire/Track Condition',
                    check: 'Inspect tracks for damage, proper tension',
                  },
                  {
                    item: 'Safety Devices',
                    check: 'Test seat belt, door locks, beacon (if equipped)',
                  },
                  {
                    item: 'Bucket/Attachment',
                    check: 'Inspect cutting edge, teeth, pins, cylinders',
                  },
                  {
                    item: 'Operator Station',
                    check: 'Clean windows, adjust mirrors, test controls',
                  },
            ...
            <ol className="space-y-3">
              <li>
                <strong>Adjust seat & controls</strong> - Position seat for comfort and full control
                reach
              </li>
              <li>
                <strong>Fasten seat belt</strong> - REQUIRED before starting engine
              </li>
              <li>
                <strong>Ensure controls in neutral</strong> - Travel levers centered, no attachment
                movement
              </li>
              <li>
                <strong>Turn key to ON position</strong> - Wait for glow plug indicator (cold
                weather)
              </li>
              <li>
                <strong>Start engine</strong> - Don't crank more than 10 seconds at a time
              </li>
              <li>
                <strong>Warm up 5 minutes</strong> - Let hydraulic oil reach operating temperature
              </li>
              <li>
                <strong>Test all functions</strong> - Slowly test travel, lift, tilt before work
              </li>
            </ol>
            ...
            <p>
              <strong>The SVL75-3 uses ISO controls (industry standard):</strong>
            </p>
            ...
            <div className="not-prose">
              <div className="my-6 rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>
                    <strong>Left Lever:</strong> Forward/back = Left track | Left/right = Bucket
                    tilt
                  </li>
                  <li>
                    <strong>Right Lever:</strong> Forward/back = Right track | Left/right = Boom
                    lift
                  </li>
                  <li>
                    <strong>Both Levers Forward:</strong> Travel forward
                  </li>
                  <li>
                    <strong>Both Levers Back:</strong> Travel backward
                  </li>
                  <li>
                    <strong>Left Forward + Right Back:</strong> Turn right (counter-rotate)
                  </li>
                  <li>
                    <strong>Right Forward + Left Back:</strong> Turn left (counter-rotate)
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="not-prose">
              <div className="my-6 space-y-3">
                ...
                ].map((rule: unknown, index: unknown) => (
                  <div
                    key={index}
            ...
            <p>
              <strong>Risk:</strong> Trench collapse can bury and kill you
              <br />
              <strong>Solution:</strong> NB regulations require trench shoring/sloping for depths
              over 1.2m (4 feet). For deep excavation, slope walls at 1:1 or use trench boxes.
            </p>

            <h3 className="text-2xl font-bold">Mistake #2: Operating on Excessive Slopes</h3>
            <p>
              <strong>Risk:</strong> Tip-overs are the #1 cause of equipment rental fatalities
              <br />
              <strong>Solution:</strong> Use a clinometer app or 25° guide. If it feels steep, it
              probably is. When in doubt, find another approach.
            </p>

            <h3 className="text-2xl font-bold">Mistake #3: Not Calling for Utility Locates</h3>
            <p>
              <strong>Risk:</strong> Hitting underground power, gas, or fiber optic can be fatal and
              costs $10,000-100,000+
              <br />
              <strong>Solution:</strong> ALWAYS call NB One Call (1-800-565-2754) at least 3
              business days before digging. It's FREE and legally required.
            </p>

            <h3 className="text-2xl font-bold">Mistake #4: Overloading the Bucket</h3>
            <p>
              <strong>Risk:</strong> Machine becomes unstable, reduced control, hydraulic strain
              <br />
              <strong>Solution:</strong> Rated operating capacity is 3,200 lb (about 1 cubic yard of
              packed clay). Take smaller bites if material is heavy.
            </p>
            ...
            <ol>
              <li>
                <strong>Position correctly</strong> - Approach dig area straight-on for maximum
                reach and power
              </li>
              <li>
                <strong>Curl bucket first</strong> - Start with bucket fully curled (teeth down)
              </li>
              <li>
                <strong>Lower & crowd</strong> - Lower boom while crowding bucket into material
              </li>
              <li>
                <strong>Curl to fill</strong> - Curl bucket to scoop and retain material
              </li>
              <li>
                <strong>Lift & swing</strong> - Raise boom and rotate to dump location
              </li>
              <li>
                <strong>Dump & return</strong> - Dump load, return to dig position, repeat
              </li>
            </ol>
            ...
            <ul>
              <li>
                Use <strong>float mode</strong> for dragging/leveling - bucket follows ground
                contour
              </li>
              <li>
                Make <strong>multiple passes</strong> - Don't try to achieve final grade in one pass
              </li>
              <li>
                Work <strong>from high to low</strong> - Push material downhill when possible
              </li>
              <li>
                <strong>Back-drag</strong> for finish grading - Pull bucket toward machine for
                smooth finish
              </li>
            </ul>
            ...
            <div className="not-prose">
              <div className="my-6 rounded-lg border-2 border-red-200 bg-red-50 p-6">
                <ol className="space-y-3 text-gray-700">
                  <li>
                    <strong>1. STOP IMMEDIATELY</strong> - Shut down engine if safe to do so
                  </li>
                  <li>
                    <strong>2. Call 911</strong> - If gas, power, or injury involved
                  </li>
                  <li>
                    <strong>3. Call utility company</strong> - Number on locate markers
                  </li>
                  <li>
                    <strong>4. Call U-Dig It Rentals</strong> - (506) 643-1575
                  </li>
                  <li>
                    <strong>5. Evacuate area</strong> - Gas line: 100m radius, Power line: Stay in
                    cab or jump clear
                  </li>
                  <li>
                    <strong>6. Document everything</strong> - Photos, witness names, exact location
                  </li>
                </ol>
              </div>
            </div>
            ...
            <ul>
              <li>
                <strong>Stay in cab if possible</strong> - ROPS (roll-over protection) will protect
                you
              </li>
              <li>
                <strong>Do NOT jump</strong> - Machine may roll onto you
              </li>
              <li>
                <strong>After stabilized:</strong> Shut down engine, exit carefully uphill side
              </li>
              <li>
                <strong>Call for help:</strong> Professional recovery required - don't attempt
                self-recovery
              </li>
            </ul>
            ...
            <p>
              <strong>Contact U-Dig It Rentals immediately if:</strong>
            </p>
            ...
            <p className="rounded-lg border-l-4 border-green-600 bg-green-50 p-6 font-medium text-green-900">
              <strong>24/7 Support:</strong> We're always available at{' '}
              <a href="tel:+15066431575" className="underline">
                (506) 643-1575
              </a>
              . If you're unsure about ANYTHING, call us. We'd rather answer questions than deal
              with accidents.
            </p>
            ...
            <div className="not-prose">
              <div className="my-8 rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
                ...
                <p className="mb-6 text-lg text-white/90">
                  Rent the Kubota SVL75-3 with complete operator orientation, safety briefing, and
                  24/7 support.
                </p>
