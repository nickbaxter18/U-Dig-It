...
export const metadata: Metadata = {
  ...
  description:
    'Expert equipment rental guides, safety tips, and local NB regulations. Learn about Kubota operation, insurance requirements, permits, and project planning in Saint John.',
  keywords:
    'equipment rental guide, kubota tips, heavy equipment safety, excavation permits nb, construction equipment insurance, saint john rental advice',
  openGraph: {
    title: 'Equipment Rental Blog | Expert Tips & Guides | U-Dig It',
    description:
      'Professional equipment rental guides for Saint John, NB. Safety tips, permits, insurance, and project planning advice.',
...
const blogPosts = [
  {
    ...
    excerpt:
      'Everything you need to know about renting construction equipment in Saint John - from choosing the right machine to delivery logistics, insurance, and permits.',
  ...
  },
  {
    ...
    excerpt:
      'Master safe operation of the Kubota SVL75-3 with our comprehensive guide covering pre-start checks, safety protocols, and expert operating tips.',
    author: 'U-Dig It Rentals Team',
  ...
  },
  {
    ...
    excerpt:
      'Navigate NB regulations with confidence. Learn about excavation permits, utility locates, insurance requirements, and legal compliance for construction projects.',
    author: 'U-Dig It Rentals Team',
            ...
            <div className="hidden md:block">
              <div className="absolute left-10 top-10 opacity-10">
                <div className="relative h-64 w-64">
                  <Image
                    ...
                    alt="U-Dig It Rentals Blog - Equipment Rental Tips Saint John"
                    fill
              ...
              <div className="absolute right-20 top-20 rotate-12 opacity-10">
                <div className="relative h-48 w-48">
                  <Image
                    src="/images/udigit-logo.png"
                    alt="Equipment Rental Guides - Kubota Safety Tips"
                    fill
                    className="object-contain"
                    sizes="48px"
                    unoptimized
              ...
              <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/4 transform opacity-10">
                <div className="relative h-96 w-96">
                  <Image
                    src="/images/udigit-logo.png"
                    alt="New Brunswick Equipment Rental Resources"
                    fill
                    className="object-contain"
                    sizes="96px"
                    unoptimized
              ...
              <div className="absolute left-0 top-1/3 -translate-x-1/4 -rotate-12 transform opacity-10">
                <div className="relative h-72 w-72">
                  <Image
                    src="/images/udigit-logo.png"
                    alt="Construction Equipment Rental Blog NB"
                    fill
                    className="object-contain"
                    sizes="72px"
                    unoptimized
              ...
              <div className="absolute bottom-20 left-32 rotate-6 opacity-10">
                <div className="relative h-56 w-56">
                  <Image
                    src="/images/udigit-logo.png"
                    alt="Heavy Equipment Operation Tips Saint John"
                    fill
                    className="object-contain"
                    sizes="56px"
                    unoptimized
              ...
              <div className="absolute bottom-10 right-10 -rotate-6 opacity-10">
                <div className="relative h-64 w-64">
                  <Image
                    src="/images/udigit-logo.png"
                    alt="Excavation Permits NB - Rental Regulations"
                    fill
                    className="object-contain"
                    sizes="64px"
                    unoptimized
              ...
              <div className="absolute left-1/2 top-5 -translate-x-1/2 rotate-3 transform opacity-10">
                <div className="relative h-40 w-40">
                  <Image
                    src="/images/udigit-logo.png"
                    alt="Professional Equipment Rental Advice"
                    fill
                    className="object-contain"
                    sizes="40px"
                    unoptimized
              ...
              <div className="absolute bottom-5 left-1/3 -rotate-3 opacity-10">
                <div className="relative h-52 w-52">
                  <Image
                    src="/images/udigit-logo.png"
                    alt="Kubota Track Loader Resources"
                    fill
                    className="object-contain"
                    sizes="52px"
                    unoptimized
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <div className="headline-3d text-center">
              ...
              <p className="mx-auto mb-8 max-w-3xl text-xl leading-relaxed text-gray-200 md:text-2xl">
                Expert tips, safety guides, and local regulations for equipment rental in New
                Brunswick
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 rounded-lg bg-gradient-to-r from-[#A90F0F] to-[#8a0c0c] p-8 text-white">
              ...
              <p className="mb-6 text-lg text-white/90">
                Put your knowledge into action! Book professional Kubota equipment for your Saint
                John project today.
              </p>
