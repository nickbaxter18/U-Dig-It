...
export default function Navigation() {
  ...
  const handleSpinWheelWin = useCallback((prize: { percentage: number; promoCode: string }) => {
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl items-center justify-center gap-2 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">
              <span className="text-[#E1BC56]">Special Offer:</span> Win Up To $100 Off Your First Rental
            </span>
          </div>
          <button
