            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-gray-200 bg-white p-4">
                  <h4 className="mb-3 flex items-center text-sm font-semibold text-gray-900">
                    <Calendar className="mr-2 h-4 w-4 text-kubota-orange" />
                    Booking Information
                  </h4>
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">{calculateDuration()} days</span>
                    </div>
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-4">
                  <h4 className="mb-3 flex items-center text-sm font-semibold text-gray-900">
                    <User className="mr-2 h-4 w-4 text-kubota-orange" />
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-4">
                  <h4 className="mb-3 flex items-center text-sm font-semibold text-gray-900">
                    <Package className="mr-2 h-4 w-4 text-kubota-orange" />
                    Equipment
                  </h4>
                  <div className="space-y-2 text-sm">
                    <div>
              ...
              <div className="space-y-4">
                {booking.deliveryAddress && (
                  <div className="rounded-lg border border-gray-200 bg-white p-4">
                    <h4 className="mb-3 flex items-center text-sm font-semibold text-gray-900">
                      <MapPin className="mr-2 h-4 w-4 text-kubota-orange" />
                      Delivery Address
                    </h4>
                ...
                {booking.specialInstructions && (
                  <div className="rounded-lg border border-gray-200 bg-white p-4">
                    <h4 className="mb-3 flex items-center text-sm font-semibold text-gray-900">
                      <MessageSquare className="mr-2 h-4 w-4 text-kubota-orange" />
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-4">
                  <h4 className="mb-3 flex items-center text-sm font-semibold text-gray-900">
                    <Clock className="mr-2 h-4 w-4 text-kubota-orange" />
                    Timeline
                  </h4>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-4">
                  <h4 className="mb-3 flex items-center text-sm font-semibold text-gray-900">
                    <DollarSign className="mr-2 h-4 w-4 text-kubota-orange" />
                    Payment Summary
                  </h4>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                    ...
                    <button
                      onClick={() => window.open(`/admin/payments?booking=${booking.id}`, '_blank')}
                ...
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mb-3 text-xs text-blue-700">
                    Quick actions are based on the current booking status. Contact customer or view
                    full booking history for more options.
                  </p>
                  <a
          ...
          {activeTab === 'communications' && (
            <div className="rounded-lg border border-gray-200 bg-white p-6">
              ...
              <div className="mt-4 flex gap-3">
                <button
                  onClick={() => alert(`Sending booking confirmation to ${booking.customer.email}`)}
