  ...
  return (
    ...
    >
      <div className="p-6">
        {/* Booking Info */}
        <div className="mb-6">
          <p className="text-sm text-gray-500">Booking: {payment.bookingNumber}</p>
        </div>

        {/* Warning */}
        <div className="mb-6 rounded-lg bg-yellow-50 border border-yellow-200 p-4 shadow-sm">
          <div className="flex">
            <AlertTriangle className="h-5 w-5 text-yellow-600 flex-shrink-0" />
            <div className="ml-3">
              <h4 className="text-sm font-semibold text-yellow-800">Important</h4>
              <p className="mt-1 text-sm text-yellow-700">
                This will initiate a refund to the customer's payment method. This action cannot be
                undone.
              </p>
            </div>
          </div>
