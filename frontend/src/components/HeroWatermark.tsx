...
export function ServiceAreaHeroWatermarks() {
  const watermarks = [
    ...
    {
      alt: 'Track Loader Rental',
      size: 240,
      position: 'right-16 top-12',
      rotation: 'rotate-[-10deg]',
    },
    {
      alt: 'Kubota Equipment',
      size: 192,
    ...
    },
    {
      alt: 'Heavy Equipment',
      size: 320,
      position: 'right-0 top-[45%] translate-x-[35%]',
      rotation: 'rotate-[15deg]',
    },
    {
      alt: 'Construction Equipment',
      size: 304,
      position: 'left-0 top-[48%] -translate-x-[35%]',
      rotation: 'rotate-[-12deg]',
    },
    {
      alt: 'Local Rental',
  ...
  return (
    <div className="pointer-events-none absolute inset-0">
      {watermarks.map((watermark: unknown, index: unknown) => (
