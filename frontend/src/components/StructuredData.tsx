...
export const organizationSchema = {
  ...
  "description": "Professional Kubota SVL-75 compact track loader rental in Saint John, New Brunswick. Reliable equipment for construction, landscaping, and excavation projects.",
  "foundingDate": "2020",
  "contactPoint": {
    "@type": "ContactPoint",
...
export const productSchema = {
  ...
  "description": "Professional compact track loader rental in Saint John, NB. 74.3 HP, 9,190 lb operating weight, ideal for construction and landscaping.",
