...
const watermarkPositions: WatermarkConfig[] = [
  { position: 1, className: 'absolute left-12 top-8 rotate-[8deg] opacity-10', size: { width: 224, height: 224 } },
  { position: 2, className: 'absolute right-16 top-12 rotate-[-10deg] opacity-10', size: { width: 240, height: 240 } },
  { position: 3, className: 'absolute left-[15%] top-[22%] rotate-[-6deg] opacity-10', size: { width: 192, height: 192 } },
  { position: 4, className: 'absolute right-[18%] top-[24%] rotate-[12deg] opacity-10', size: { width: 208, height: 208 } },
  { position: 5, className: 'absolute right-0 top-[45%] translate-x-[35%] rotate-[15deg] transform opacity-10', size: { width: 320, height: 320 } },
  { position: 6, className: 'absolute left-0 top-[48%] -translate-x-[35%] rotate-[-12deg] transform opacity-10', size: { width: 304, height: 304 } },
  { position: 7, className: 'absolute bottom-[12%] left-[20%] rotate-[4deg] opacity-10', size: { width: 176, height: 176 } },
  { position: 8, className: 'absolute bottom-[10%] right-[22%] rotate-[-7deg] opacity-10', size: { width: 192, height: 192 } },
  { position: 9, className: 'absolute left-[30%] top-[11%] rotate-[5deg] opacity-10', size: { width: 160, height: 160 } },
];
...
export function GeoWatermark({ location, position }: GeoWatermarkProps) {
  ...
  return (
    <div className={config.className}>
      <div className="relative" style={{ width: `${config.size.width}px`, height: `${config.size.height}px` }}>
        <Image
  ...
  return (
    <div className="pointer-events-none absolute inset-0">
      ...
      <div className="hidden md:block">
        {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((position: any) => (
